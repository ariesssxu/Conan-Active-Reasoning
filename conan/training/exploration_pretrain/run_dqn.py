...
if __name__ == '__main__':
    ...
    parser.add_argument('--outdir', default=os.path.join(pathlib.Path(__file__).parent, '../ckpt/rl/conan_nav_dqn/'))
    parser.add_argument('--steps', type=float, default=1e8)
    parser.add_argument('--nenvs', type=int, default=128)
    parser.add_argument('--buffer_size', type=int, default=1e6)
    parser.add_argument('--bs', type=int, default=128)
    parser.add_argument('--tensorboard-log', type=str, default=os.path.join(pathlib.Path(__file__).parent, '../tensorboard_log/conan_nav_dqn/'))
