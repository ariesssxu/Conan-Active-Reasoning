...
from model import build_model, get_tokenizer, build_head_model
...
def train_one_epoch(
    ...
    for i_batch, batch_dict in enumerate(
        ...
        video_len = batch_dict["video_len"]/30
        video_mask = get_mask(video_len, 1).to(device)        
...
def main(args):
    ...
    for dset_name in ["conan"]:
        ...
        if not args.eval:
            dataset_train = build_mc_dataset(
                dset_name, "train", args, tokenizer)
            sampler_train = (
