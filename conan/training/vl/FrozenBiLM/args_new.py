...
def get_args_parser():
    ...
    # Dataset specific
    parser.add_argument(
        "--conan_train_config_path",
        default=os.path.join(DATA_DIR, "train", "config.json"),
    )
    parser.add_argument(
        "--conan_val_config_path",
        default=os.path.join(DATA_DIR, "test", "config.json"),
    )
    parser.add_argument(
        "--conan_test_config_path",
        default=os.path.join(DATA_DIR, "val", "config.json"),
    )
    parser.add_argument(
        "--conan_vocab_path",
        default=None,
    ...
    parser.add_argument(
        "--head",
        default=False,
        help="whether to use the fc head",
    )
    parser.add_argument(
        "--n_ans",
        type=int,
    ...
    parser.add_argument(
        "--head_path", default="", help="path to load head ckpt"
    )
    parser.add_argument(
        "--presave_dir",
        default=PRESAVE_DIR,
